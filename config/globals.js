...
module.exports.globals = {
  ...
  ****************************************************************************/
	...
	// models: true,
   uploadPath:'/usr/local/www/project/apppic/',
   ImageUrl:'/apppic/',


  //千里云统一账号
  unityhost:"ssoapi.loginme.cn",
  unitypath:"/ssos/rest/ssoAPI",
  unityport:81,
  unityapiKey: "25CE3E3E91ED48E4A8966E7A051808BB",
  unitysecretKey: "2EC69ECD50D54094ADD545A07B2A941B",

  //快递100参数
  kuaidi100:'https://devnode.darlinglive.com',
  storedeliver:'/DeliverStore/deliverTrack',
  usersdeliver:'/DeliverClient/deliverTrack',

  //vr资源件路径
  vrxmlpath: '/usr/local/www/project/vrxml/www',
  vrpicxmlpath: '/usr/local/www/project/appfile/vrpicxml/www',
  vrvideoxmlpath: '/usr/local/www/project/appfile/vrvideoxml/www',
