...
module.exports = {
    ...
    /*
        Check session for socket process
        API: /notification/sendMsg
        parameters: 
        return：{'success': true,'code':200,"msg": "SESSION_ACQURED_SUCCESS"}
    */
    checkSession: function (req, res) {
        console.log('checkSession: This is the function that check session; apparently you pass');       

        return res.json({
            "success": true,
            "msgCode": 200,
            "msg": "SESSION_ACQURED_SUCCESS",
        }); 
    ...
    */
    create: function (req, res) {
        ...
        //Account.find({operatorno: storeId}).exec(function (err, userResults) {
            ...
            phoneArray.forEach(function(elem,key){
                ...
                // return NotifyOnline
                // .create({ userName: nickName.trim(), socketId: socket.id, roomName: elem})
    ...
    */
    ...
    sendMsg_android: function (req, res, phoneArray, callback) {
        ...
        async.mapSeries(phoneArray, function(item,callback){
            ...
            //check who's online
            NotifyOnline.find({userName: item, roomName: item}).exec(function (err, userResult) {
                if (err) return res.negotiate(err);
                ...
                sails.sockets.broadcast(item, 'notification', message);
