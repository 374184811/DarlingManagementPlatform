...
module.exports = {
    ...
    addScheduleOfTimeMinute:function(refundrnumber,tablenameofitem,triggerMinute,typeOfTri,scheduleinfo3){

        var nowDate = new Date().getTime()+60*1000*triggerMinute;
        var nowDate2 = new Date().setTime(nowDate);
        var timestrdayAfter = new Date(nowDate2).Format("yyyy-MM-dd hh:mm:ss");
        var dateInfo = new Date();
        var timestr = dateInfo.Format("yyyy-MM-dd hh:mm:ss");
        if(!scheduleinfo3){
            scheduleinfo3='0';
